...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    a: common_vendor.o(($event) => $data.formData.type = $event, "f5"),
    b: common_vendor.p({
      multiple: false,
    ...
    d: common_vendor.o(($event) => $data.formData.type_name = $event, "c2"),
    e: common_vendor.p({
    ...
    g: common_vendor.o(($event) => _ctx.binddata("comment", $event.detail.value), "ba"),
    h: $data.formData.comment,
    i: common_vendor.p({
      name: "comment",
      label: "备注"
    }),
    j: common_vendor.o(($event) => $data.formData.username = $event, "32"),
    k: common_vendor.p({
    ...
    m: common_vendor.o(($event) => $data.formData.email = $event, "47"),
    n: common_vendor.p({
      placeholder: "邮箱",
    ...
    p: common_vendor.o(($event) => $data.formData.dowload_url = $event, "e3"),
    q: common_vendor.p({
    ...
    s: common_vendor.o(($event) => $data.formData.weight = $event, "89"),
    t: common_vendor.p({
    ...
    w: common_vendor.o(($event) => $data.formData.favorite_book = $event, "55"),
    x: common_vendor.p({
      collection: "book",
    ...
    z: common_vendor.o(($event) => _ctx.binddata("party_member", $event.detail.value), "35"),
    A: $data.formData.party_member,
    B: common_vendor.p({
      name: "party_member",
      label: "是否为党员"
    }),
    C: common_vendor.o(($event) => $data.formData.hobby = $event, "79"),
    D: common_vendor.p({
      multiple: true,
    ...
    F: common_vendor.o(($event) => $data.formData.address = $event, "dd"),
    G: common_vendor.p({
      ["self-field"]: "code",
    ...
    I: common_vendor.o((...args) => $options.submit && $options.submit(...args), "f5"),
    J: common_vendor.sr("form", "f8e77554-0"),
    K: common_vendor.p({
      value: $data.formData,
