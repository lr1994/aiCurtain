...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    h: $props.focus,
    i: $data.val,
    j: common_vendor.o(($event) => $data.val = $event.detail.value, "19")
  }, {
    k: $props.showClose
  }, $props.showClose ? {
    l: common_vendor.t($options.closeText),
    m: common_vendor.o((...args) => $options.closeDialog && $options.closeDialog(...args), "0e")
  } : {}, {
    n: common_vendor.t($options.okText),
    o: common_vendor.n($props.showClose ? "uni-border-left" : ""),
    p: common_vendor.o((...args) => $options.onOk && $options.onOk(...args), "d8"),
