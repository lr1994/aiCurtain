...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
      ...
      return common_vendor.e({
        ...
        d: common_vendor.f(data, (item, index, i1) => {
          return {
            ...
            d: "eb0a358e-2-" + i0 + "-" + i1 + "," + ("eb0a358e-1-" + i0)
          };
        }),
        e: common_vendor.p({
          showArrow: true,
        ...
        f: "eb0a358e-1-" + i0 + ",eb0a358e-0"
      } : {}, {
        c: data,
        g: loading
      }, loading ? {
        h: "eb0a358e-3-" + i0 + ",eb0a358e-0",
        i: common_vendor.p({
    ...
    b: common_vendor.sr("udb", "eb0a358e-0"),
    c: common_vendor.p({
    ...
    d: common_vendor.sr("fab", "eb0a358e-4"),
    e: common_vendor.o($options.fabClick, "72"),
    f: common_vendor.p({
      horizontal: "right",
      vertical: "bottom",
      ["pop-menu"]: false
