...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    f: common_vendor.o((...args) => $options.pre && $options.pre(...args), "f3")
  } : {}, {
    g: common_vendor.t(($data.nowDate.year || "") + $options.yearText + ($data.nowDate.month || "") + $options.monthText),
    h: $props.date,
    i: common_vendor.o((...args) => $options.bindDateChange && $options.bindDateChange(...args), "92"),
    j: $props.right
  }, $props.right ? {
    k: common_vendor.o((...args) => $options.next && $options.next(...args), "56")
  } : {}, {
    l: !$props.insert
  }, !$props.insert ? {
    m: common_vendor.o((...args) => $options.clean && $options.clean(...args), "07")
  } : {}, {
    n: !$props.insert ? 1 : "",
    o: $props.showMonth
  }, $props.showMonth ? {
    ...
    B: common_vendor.o(($event) => $data.time = $event, "86"),
    C: common_vendor.p({
      type: "time",
    ...
    F: common_vendor.o(($event) => $data.timeRange.startTime = $event, "1b"),
    G: common_vendor.p({
      type: "time",
      start: $options.reactStartTime,
      border: false,
    ...
    J: common_vendor.o(($event) => $data.timeRange.endTime = $event, "f3"),
    K: common_vendor.p({
      type: "time",
      end: $options.reactEndTime,
      border: false,
    ...
    N: common_vendor.o((...args) => $options.confirm && $options.confirm(...args), "c3")
  } : {}, {
    O: !$props.insert ? 1 : "",
    P: $data.aniMaskShow ? 1 : "",
    Q: $data.aniMaskShow ? 1 : ""
  }) : {}, {
    R: common_vendor.o((...args) => $options.leaveCale && $options.leaveCale(...args), "a2")
  });
}
