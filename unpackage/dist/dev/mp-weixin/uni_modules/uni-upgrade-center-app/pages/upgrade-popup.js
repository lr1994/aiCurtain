...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    g: common_vendor.o((...args) => $options.jumpToAppStore && $options.jumpToAppStore(...args), "3a")
  } : common_vendor.e({
    ...
    o: common_vendor.o((...args) => $options.updateApp && $options.updateApp(...args), "d9")
  }) : $data.downloadSuccess && !$data.installed ? {
    q: common_vendor.t($data.installing ? "正在安装……" : "下载完成，立即安装"),
    r: $data.installing,
    s: $data.installing,
    t: common_vendor.o((...args) => $options.installPackage && $options.installPackage(...args), "50")
  } : {}, {
    p: $data.downloadSuccess && !$data.installed,
    v: $data.installed && $options.isWGT
  }, $data.installed && $options.isWGT ? {
    w: common_vendor.o((...args) => $options.restart && $options.restart(...args), "aa")
  } : {}), {
    x: !$data.is_mandatory
  }, !$data.is_mandatory ? {
    y: common_assets._imports_1,
    z: common_vendor.o((...args) => $options.closeUpdate && $options.closeUpdate(...args), "c0")
  } : {});
}
