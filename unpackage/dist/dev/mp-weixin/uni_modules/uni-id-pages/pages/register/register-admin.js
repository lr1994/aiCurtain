...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    g: common_vendor.o(($event) => $data.formData.nickname = $event, "0e"),
    h: common_vendor.p({
      inputBorder: false,
    ...
    k: common_vendor.o(($event) => $data.formData.password = $event, "fd"),
    l: common_vendor.p({
      inputBorder: false,
    ...
    o: common_vendor.o(($event) => $data.focusPassword2 = false, "27"),
    p: common_vendor.o(($event) => $data.formData.password2 = $event, "c8"),
    q: common_vendor.p({
      inputBorder: false,
    ...
    r: common_vendor.o(($event) => $data.formData.password2 = $event, "32"),
    s: common_vendor.p({
      name: "password2",
      required: true,
      modelValue: $data.formData.password2
    }),
    t: common_vendor.sr("agreements", "1c95da38-9,1c95da38-0"),
    v: common_vendor.p({
      scope: "register"
    }),
    w: common_vendor.o((...args) => $options.submit && $options.submit(...args), "11"),
    x: common_vendor.o((...args) => $options.navigateBack && $options.navigateBack(...args), "54"),
    y: common_vendor.o((...args) => $options.toLogin && $options.toLogin(...args), "51"),
    z: common_vendor.sr("form", "1c95da38-0"),
    A: common_vendor.p({
      value: $data.formData,
      rules: $data.rules,
