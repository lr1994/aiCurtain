...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
      ...
      return common_vendor.e({
        ...
        d: common_vendor.f(data, (item, index, i1) => {
          return {
            ...
            d: "1efdfbc3-2-" + i0 + "-" + i1 + "," + ("1efdfbc3-1-" + i0)
          };
        }),
        e: common_vendor.p({
          showArrow: true,
        ...
        f: "1efdfbc3-1-" + i0 + ",1efdfbc3-0"
      } : {}, {
        c: data,
        g: "1efdfbc3-3-" + i0 + ",1efdfbc3-0",
        h: common_vendor.p({
    ...
    b: common_vendor.sr("udb", "1efdfbc3-0"),
    c: common_vendor.p({
    ...
    d: common_vendor.sr("fab", "1efdfbc3-4"),
    e: common_vendor.o($options.fabClick, "9a"),
    f: common_vendor.p({
      horizontal: "right",
      vertical: "bottom",
      ["pop-menu"]: false
