...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    i: common_vendor.o((...args) => $options.showAgreementModal && $options.showAgreementModal(...args), "70")
  } : {}), {
    ...
    l: common_vendor.o((...args) => $options.chooseArea && $options.chooseArea(...args), "01"),
    m: common_vendor.o(($event) => $data.focusPhone = false, "48"),
    n: common_vendor.o(($event) => $data.phone = $event, "71"),
    o: common_vendor.p({
      trim: "both",
    ...
    r: common_vendor.o((...args) => $options.toSmsPage && $options.toSmsPage(...args), "7b")
  }, {
