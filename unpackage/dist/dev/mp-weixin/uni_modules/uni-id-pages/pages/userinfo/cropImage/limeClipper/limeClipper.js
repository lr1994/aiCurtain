...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    c: common_vendor.o((...args) => $options.clipTouchStart && $options.clipTouchStart(...args), "66"),
    d: common_vendor.o((...args) => $options.clipTouchMove && $options.clipTouchMove(...args), "f4"),
    e: common_vendor.o((...args) => $options.clipTouchEnd && $options.clipTouchEnd(...args), "c8"),
    f: $data.image
  }, $data.image ? {
    g: common_vendor.o((...args) => $options.imageLoad && $options.imageLoad(...args), "1a"),
    h: common_vendor.o((...args) => $options.imageLoad && $options.imageLoad(...args), "94"),
    i: common_vendor.o((...args) => $options.imageTouchStart && $options.imageTouchStart(...args), "08"),
    j: common_vendor.o((...args) => $options.imageTouchMove && $options.imageTouchMove(...args), "66"),
    k: common_vendor.o((...args) => $options.imageTouchEnd && $options.imageTouchEnd(...args), "61"),
    l: $data.image,
    ...
    s: common_vendor.o((...args) => $options.cancel && $options.cancel(...args), "24")
  }) : {}, {
    ...
    E: common_vendor.o((...args) => $options.confirm && $options.confirm(...args), "97")
  }) : {}, {
    F: $props.value ? 1 : "",
