...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    d: $data.singleVal,
    e: common_vendor.o(($event) => $data.singleVal = $event.detail.value, "fc")
  } : {
    f: common_vendor.p({
      type: "calendar",
      color: "#c0c4cc",
    ...
    i: common_vendor.o(($event) => $data.range.startDate = $event.detail.value, "0e"),
    j: common_vendor.t($props.rangeSeparator),
    k: $options.endPlaceholderText,
    l: $data.range.endDate,
    m: common_vendor.o(($event) => $data.range.endDate = $event.detail.value, "81")
  }, {
    ...
    p: common_vendor.o((...args) => $options.clear && $options.clear(...args), "ea")
  } : {}, {
    q: $props.disabled ? 1 : "",
    r: $props.border ? 1 : "",
    s: common_vendor.o((...args) => $options.show && $options.show(...args), "71"),
    t: $data.popup,
    v: common_vendor.o((...args) => $options.close && $options.close(...args), "17"),
    w: !$data.isPhone
    ...
    B: common_vendor.o(($event) => $data.tempSingleDate = $event.detail.value, "be"),
    C: $options.selectTimeText,
    D: !$data.tempSingleDate,
    E: $data.time,
    F: common_vendor.o(($event) => $data.time = $event.detail.value, "a3"),
    G: common_vendor.o(($event) => $data.time = $event, "d8"),
    H: common_vendor.p({
      type: "time",
      border: false,
    ...
    I: common_vendor.sr("pcSingle", "d2278208-4"),
    J: common_vendor.o($options.singleChange, "63"),
    K: common_vendor.p({
      showMonth: false,
    ...
    N: common_vendor.o((...args) => $options.confirmSingleChange && $options.confirmSingleChange(...args), "45")
  } : {}, {
    ...
    S: common_vendor.o(($event) => $data.tempRange.startDate = $event.detail.value, "c6"),
    T: $options.startTimeText,
    U: !$data.tempRange.startDate,
    V: $data.tempRange.startTime,
    W: common_vendor.o(($event) => $data.tempRange.startTime = $event.detail.value, "20"),
    X: common_vendor.o(($event) => $data.tempRange.startTime = $event, "cd"),
    Y: common_vendor.p({
      type: "time",
      start: $options.reactStartTime,
      border: false,
    ...
    ac: common_vendor.o(($event) => $data.tempRange.endDate = $event.detail.value, "8f"),
    ad: $options.endTimeText,
    ae: !$data.tempRange.endDate,
    af: $data.tempRange.endTime,
    ag: common_vendor.o(($event) => $data.tempRange.endTime = $event.detail.value, "ba"),
    ah: common_vendor.o(($event) => $data.tempRange.endTime = $event, "ae"),
    ai: common_vendor.p({
      type: "time",
      end: $options.reactEndTime,
      border: false,
    ...
    aj: common_vendor.sr("left", "d2278208-8"),
    ak: common_vendor.o($options.leftChange, "8e"),
    al: common_vendor.o($options.updateRightCale, "9f"),
    am: common_vendor.o($options.leftMonthSwitch, "f7"),
    an: common_vendor.p({
      showMonth: false,
      ["start-date"]: $data.caleRange.startDate,
      ["end-date"]: $data.caleRange.endDate,
    ...
    ao: common_vendor.sr("right", "d2278208-9"),
    ap: common_vendor.o($options.rightChange, "7e"),
    aq: common_vendor.o($options.updateLeftCale, "0b"),
    ar: common_vendor.o($options.rightMonthSwitch, "c2"),
    as: common_vendor.p({
      showMonth: false,
      ["start-date"]: $data.caleRange.startDate,
      ["end-date"]: $data.caleRange.endDate,
    ...
    aw: common_vendor.o((...args) => $options.clear && $options.clear(...args), "ef"),
    ax: common_vendor.t($options.okText),
    ay: common_vendor.o((...args) => $options.confirmRangeChange && $options.confirmRangeChange(...args), "57")
  } : {}, {
    az: common_vendor.s($data.popover)
  }), {
    aA: $data.popup
  }) : {}, {
    aB: common_vendor.sr("mobile", "d2278208-10"),
    aC: $data.isPhone,
    aD: common_vendor.o($options.mobileChange, "bc"),
    aE: common_vendor.o($options.close, "8d"),
    aF: common_vendor.p({
      clearDate: false,
      date: $data.defSingleDate,
